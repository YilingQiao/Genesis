...
def vec_types(use_ndarray: bool):
    def choose(dtype):
        return ti.types.ndarray(dtype=dtype) if use_ndarray else ti.template()
    ...
    ns = SimpleNamespace(
        ...
        G=ti.types.ndarray() if use_ndarray else ti.template(),
    )

    return ns


def get_array_type(use_ndarray: bool):
    return ti.ndarray if use_ndarray else ti.field


@ti.data_oriented
class DataClass:
    def __init__(self, use_ndarray: bool):
        self.use_ndarray = use_ndarray
        self.VT = get_array_type(use_ndarray)


@ti.data_oriented
class GlobalData(DataClass):
    def __init__(self, use_ndarray: bool, n_dofs: int, n_entities: int, n_geoms: int, f_batch: Callable):
        super().__init__(use_ndarray)
        ...
        ############################## qpos
        self.qpos = self.VT(dtype=gs.ti_float, shape=f_batch((n_dofs,)))
        self.qpos0 = self.VT(dtype=gs.ti_float, shape=f_batch((n_dofs,)))


@ti.data_oriented
class VertsInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_verts: int):
        super().__init__(use_ndarray)
...
class FacesInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_faces: int):
        super().__init__(use_ndarray)
...
class VvertsInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_vverts: int):
        super().__init__(use_ndarray)
...
class VfacesInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_vfaces: int):
        super().__init__(use_ndarray)
...
class GeomsState(DataClass):
    def __init__(self, use_ndarray: bool, n_geoms: int, f_batch: Callable):
        super().__init__(use_ndarray)
...
class GeomsInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_geoms: int):
        super().__init__(use_ndarray)
...
class VgeomsInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_vgeoms: int):
        super().__init__(use_ndarray)
...
class VgeomsState(DataClass):
    def __init__(self, use_ndarray: bool, n_vgeoms: int, f_batch: Callable):
        super().__init__(use_ndarray)
...
class VertsState(DataClass):
    def __init__(self, use_ndarray: bool, n_verts: int, f_batch: Callable):
        super().__init__(use_ndarray)
...
class EdgesInfo(DataClass):
    def __init__(self, use_ndarray: bool, n_edges: int):
        super().__init__(use_ndarray)
...
class DofsInfo(DataClass):
    def __init__(self, use_ndarray: bool, shape: tuple):
        super().__init__(use_ndarray)
